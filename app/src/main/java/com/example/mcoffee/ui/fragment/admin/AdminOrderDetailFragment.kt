...
@AndroidEntryPoint
class AdminOrderDetailFragment : BaseFragment<FragmentOrderDetailAdminBinding>(FragmentOrderDetailAdminBinding::inflate) {
    ...
    override fun bindView() {
        ...
        binding.btnConfirm.setOnClickListener {
            adminConfirmOrderViewModel.confirmOrder(orderInfo)
        }
    ...
    private fun showDialog(orderInfo: Order) {
        val alertDialog = AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("Xác nhận") { _, _ ->
                adminConfirmOrderViewModel.abortOrder(orderInfo)
            }
